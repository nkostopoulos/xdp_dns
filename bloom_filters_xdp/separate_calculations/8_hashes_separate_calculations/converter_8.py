...
file2 = open("c_code_8", "w")

bf_size = 121288

file2.write("int myArray[121288];\n")
file2.write("uint64_t result1, result2, result3, result4, result5, result6, result7, result8;\n")
file2.write("uint32_t hash1, hash2, hash3, hash4, hash5, hash6, hash7, hash8;\n")
