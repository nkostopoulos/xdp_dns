...
file2 = open("c_code_6", "w")

bf_size = 131056

file2.write("int myArray[131056];\n")
file2.write("uint64_t result1, result2, result3, result4, result5, result6;\n")
file2.write("uint32_t hash1, hash2, hash3, hash4, hash5, hash6;\n")
