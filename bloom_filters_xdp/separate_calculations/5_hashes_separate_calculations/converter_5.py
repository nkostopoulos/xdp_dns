...
file2 = open("c_code_5", "w")

bf_size = 143520

file2.write("int myArray[143520];\n")
file2.write("uint64_t result1, result2, result3, result4, result5;\n")
file2.write("uint32_t hash1, hash2, hash3, hash4, hash5;\n")
